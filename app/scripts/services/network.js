...
rpNetwork.$inject = ['$rootScope', '$timeout', 'config'];

function rpNetwork($scope, $timeout, config) {
  /**
  ...
  {
    this.remote = new ripple.Remote(config.server, true);
    ...
    this.remote.max_fee = config.max_tx_network_fee || 12;
